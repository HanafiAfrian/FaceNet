...
import 'package:face_net_authentication/pages/widgets/presensiauth_form.dart';
...
class PresensiAuth extends StatefulWidget {
  ...
  @override
  PresensiAuthState createState() => PresensiAuthState();
}

class PresensiAuthState extends State<PresensiAuth> {
  ...
  presensiAuthSheet({@required User? user}) => user == null
      ? Container(
